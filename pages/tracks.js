...
const Track = ({ title, caption, icon }) => {
  return (
    <div className="flex-1 flex flex-col items-center justify-start px-6 py-10 bg-white
     border-2 border-red-100 rounded-md space-y-4 w-full shadow-none hover-hover:hover:shadow-2xl
      hover-hover:hover:bg-red-100 transition duration-300 ease-in-out">
      <div>{icon}</div>
